...
Shader "Unlit/chapter7/MaskTexture"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 _Color;
			sampler2D _MainTex, _BumpMap, _SpecularMask;
			float4 _MainTex_ST;
			fixed4 _Specular;
			float _Gloss, _BumpScale, _SpecularScale;
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed3 specular = _LightColor0.xyz * _Specular.rgb * pow(max(0, dot(tangentNormal, halfDir)), _Gloss) * specularMask;
